...
class DetectorSimulator:
    ...
    - hit_signals: Diffused charge without response
        ...
        def _calculate_signals_jit(
            ...
            for side_idx in range(2):
                ...
                for plane_idx in range(3):
                    ...
                    hit_signals_list.append(None)
                    track_hits_list.append(track_hit_result)

            return tuple(response_signals_list), tuple(hit_signals_list), tuple(track_hits_list)
    ...
    def process_event(self, deposit_data: DepositData):
        ...
        hit_signals : dict[(side, plane)] -> None
            Placeholder (use track_hits for hit information).
        ...
        response_tuple, hit_tuple, track_hits_tuple = self._calculator_jit_raw(
            # East data
        ...
        for side_idx in range(2):
            for plane_idx in range(3):
                ...
                hit_signals[(side_idx, plane_idx)] = hit_tuple[idx]
        ...
        return response_signals, hit_signals, track_hits
...
def run_simulation(config_path, data_path, event_idx=0,
    ...
    hit_signals : dict
        Placeholder dict (use track_hits).
    track_hits : dict
    ...
    try:
        ...
        response_signals, hit_signals, track_hits = simulator(deposit_data)
        ...
        return response_signals, hit_signals, track_hits, simulator
